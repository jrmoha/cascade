...
| [0020](0020-kafka-partitioning-and-scaling.md)           | Kafka partitioning & scaling (6 partitions/RF3, 3 brokers, session key, scaled consumers)     | Accepted             |
| [0021](0021-ingestion-resilience.md)                     | Ingestion resilience (rate limiting, backpressure, produce retries, circuit breaker, k6 gate) | Accepted             |
