...
import { queryApiEnvSchema, type QueryApiConfig } from './env.schema';
 ...
 * env) and exposes a frozen, fully-typed {@link QueryApiConfig} as a global
  ...
  providers: [
    {
      ...
      useFactory: (): QueryApiConfig => Object.freeze(queryApiEnvSchema.parse(process.env)),
    },
  ],
  exports: [APP_CONFIG],
})
