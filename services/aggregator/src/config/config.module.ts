...
import { aggregatorEnvSchema, type AggregatorConfig } from './env.schema';
 ...
 * env) and exposes a frozen, fully-typed {@link AggregatorConfig} as a global
  ...
  providers: [
    {
      ...
      useFactory: (): AggregatorConfig => Object.freeze(aggregatorEnvSchema.parse(process.env)),
    },
  ],
  exports: [APP_CONFIG],
})
